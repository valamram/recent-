...
public class sjfs_Scheduler {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < Constants.NO_OF_DATA_CENTERS; i++) {
                datacenter[i] = DatacenterBroker.createDatacenter("Datacenter_" + i);
            }

            //Third step: Create Broker
            sjfsDatacenterBroker broker = createBroker("Broker_0");
            ...
            Log.printLine(sjfs_Scheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static sjfsDatacenterBroker createBroker(String name) throws Exception {
        return new sjfsDatacenterBroker(name);
    }
